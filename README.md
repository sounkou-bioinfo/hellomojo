...
#> [1] TRUE
mojo_result |> head()
#> [1]  0.11081905 -0.02055829 -0.49857824 -1.15578083 -1.42782320 -0.95238950
# Benchmark
bench::mark(
...
#> 1 mojo         10.7µs   24.4µs    40666.    78.2KB     57.0
#> 2 c              10µs     33µs    31784.    78.2KB     44.6
```
...
#> Creating virtual environment at: /tmp/Rtmpd2C4TO/mojo_venv_12d39f2c95c282
#> Installing Mojo nightly build...
#> Mojo installed successfully at: /tmp/Rtmpd2C4TO/mojo_venv_12d39f2c95c282/bin/mojo

# Check the size of the Mojo installation
venv_size <- system2("du", c("-sh", venv_path), stdout = TRUE)
venv_size
#> [1] "691M\t/tmp/Rtmpd2C4TO/mojo_venv_12d39f2c95c282"
...
#> Using Mojo: /tmp/Rtmpd2C4TO/mojo_venv_12d39f2c95c282/bin/mojo
#> Parsing Mojo file: /tmp/Rtmpd2C4TO/file12d39f1e1ed32c.mojo
...
#> Loading DLL: /tmp/Rtmpd2C4TO/mojo_compile_12d39f4fd062d1/mojo_wrappers.so
